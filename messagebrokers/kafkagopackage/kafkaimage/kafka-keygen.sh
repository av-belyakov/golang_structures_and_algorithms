...
# IP.1 = 127.0.0.1
#
# !!! Вот это поле с IP-адресами и доменными именами очень важно для сертификата
# Kafka будет откланять соединение если оно будет устанавливатся с IP-адресов или
# доменных имён которые отсутсвуют в списке [alt_names]
